...
def get_probe_dataset(probe_dataset, probe_split, probe_dataset_root_dir, preprocess_fn, split_idxs=None):
    ...
    """
    download = False
    print(f"Loading probe dataset from root dir: {probe_dataset_root_dir}")
    # Print the folders within the train folder of the root dir
    # train_dir = os.path.join(probe_dataset_root_dir, 'train')
    # if os.path.isdir(train_dir):
    #     print("Folders within the train directory:")
    ...
    if probe_dataset == "imagenet":
        ...
        dataset = torchvision.datasets.CIFAR100(
            root=os.path.join(probe_dataset_root_dir), train=probe_split == "train", download=download, transform=preprocess_fn)
        ...
        print("PRINTING THE PATH:", os.path.join(probe_dataset_root_dir))
