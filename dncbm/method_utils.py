...
# # Add the parent directory of `sparse_autoencoder` to sys.path
# repo_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "../.."))
# sparse_autoencoder_dir = os.path.join(repo_root, "sparse_autoencoder")
# if sparse_autoencoder_dir not in sys.path:
#     sys.path.insert(0, sparse_autoencoder_dir)

# from sparse_autoencoder import SparseAutoencoder
# # try:
# #     from sparse_autoencoder.sparse_autoencoder import SparseAutoencoder
# #     print("SparseAutoencoder imported successfully!")
# # except ImportError as e:
# #     print(f"Failed to import SparseAutoencoder: {e}")
...
class MethodOurs(MethodBase):
    ...
    def __init__(self, args, vocab_txt_path=None, embeddings_path=None, use_fixed_sae=False, use_sae_from_args=False, **kwargs):
        ...
        if use_fixed_sae:
            ...
            self.probe_config_dict = {'imagenet': "lr0.01_bs512_epo200_nobias_clCE_spL1_spl0.1",
                                    'cifar100': "lr0.01_bs512_epo200_nobias_clCE_spL1_spl0.1",
                                    'cifar10': "lr0.01_bs512_epo200_nobias_clCE_spL1_spl0.1",
                                    'places365': "lr0.01_bs512_epo200_nobias_clCE_spL1_spl0.1",
                                    
                                    'waterbirds100': 'lr0.1_bs512_epo200_nobias_clCE_spL1_spl10.0', } # not used
