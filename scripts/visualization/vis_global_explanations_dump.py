...
print(f"Class images size: {len(class_images)}")
print(f"Number of classes: {args.probe_nclasses}")
...
for plt_idx, class_idx in enumerate(range(args.probe_nclasses)):
    ...
    print(f"Class name and idx: {class_name} | {class_idx}")
    this_class_concepts = all_concepts[all_labels == class_idx]
    print(f"this class concepts size: {len(this_class_concepts)}")
    ...
    print(f"imgs_this_class: {imgs_this_class}")
