...
def main(args):
    ...
    print(f"Printing the first 10 labels: {train_labels[:10]}")
    ...
    print("Printing the shape train",train_data.shape, train_labels.shape)
    print("Printing the shape trainval",train_val_data.shape, train_val_labels.shape)
    print("Printing the shape test",test_data.shape, test_labels.shape)
